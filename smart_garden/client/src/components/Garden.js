...
class Garden extends Component {
    ...
    createGarden = (e) => {
        ...
        this.gardenPlot = height.map(ind => {
            const gardenColumns = width.map(myInd => {
                ...
                return <div className='cell' onClick={this.props.cellClick} id={index}>
                    {index}
    ...
    loadSavedGarden = () => {
        this.testDiv = this.props.selectedGardenData.map(plot => {
            ...
            return (
                <div className='cell' id={plot.cell} style={{ backgroundColor: rgbColor }} onClick={this.props.cellClick}> {plot.contents} </div>
            )
        })
    }
