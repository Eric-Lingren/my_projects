...
var diffContext = canvas.getContext('2d');
...
function capture() {
    ...
    //calculateImageData(imageData)

    // diff current capture over previous capture, leftover from last time
    diffContext.globalCompositeOperation = 'difference';
    diffContext.drawImage(video, 0, 0, 640, 480);
    var diffImageData = diffContext.getImageData(0, 0, 640, 480);
...
function calculateImageData(imageData){
